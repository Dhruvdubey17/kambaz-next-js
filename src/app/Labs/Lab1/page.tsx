  ...
  return (
    <div id="wd-labs">
      ...
      <div id="wd-lists">
        ...
        How to make instant noodles(my favourite recipe):
        <ol id="wd-pancakes">
          <li>Start boiling water in a pan.</li>
          <li>Add noodles once the water starts boiling.</li>
          <li>After a min add the instant noodle mix.</li>
          <li>Stir well.</li>
          <li>Let them cook for 2 mins.</li>
          <li>Noodles are ready, serve them hot.</li>
        </ol>
      ...
      <div id="wd-images">
        ...
        <Image
          ...
          alt="Starship Image"
          width={400}
          height={300} // you need to provide height too
        />
        <br />
      ...
      <br />
      <input type="radio" name="radio-genre" id="wd-radio-comedy" />
      <label htmlFor="wd-radio-black">Black</label>
      <br />
      <input type="radio" name="radio-genre" id="wd-radio-drama" />
      ...
      <br />
      <h4>Anchor tag</h4>
      <a href="https://www.wikipedia.org/" id="wd-wikipedia">
        Wikipedia
      </a>
      <br />
